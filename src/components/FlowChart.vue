<template>
  <div class="container-flowchart">
    <div class="parent flex justify-start">
      <MobileHeader class="" title="AI Chat Helper" />
      <div
        class="chat h-5/6 left-2/4 transform -translate-x-1/2 bg-white rounded-t-3xl w-full lg:w-3/4 lg:translate-x-0 lg:right-8 lg:ml-10 lg:left-auto xl:w-3/4">
        <div class="sst" ref="canvas"></div>
      </div>

      <div
        class="hidden flex-col lg:flex-row lg:flex lg:ml-16 xl:ml-28 capitalize font-bold text-lg left-2/4 transform -translate-x-1/2 lg:translate-x-0 lg:right-8 lg:left-auto float-end mt-10">
 <div>
</div>
          ...
          <button
            class="text-red-400 lg:bg-red-400 lg:hover:bg-red-500 lg:text-white px-5 py-1 flex justify-center items-center"
            @click="saveDiagram">
            <span>Save</span>
        ...
        <div class="flex items-center">
          <div class="flex">
            <button class="btn-download ml-5" @click="downloadDiagram">
    ...
    <div class="flex justify-between items-center lg:mt-8">
      <div class="lg:hidden" style="margin-top: 62px;">
        ...
        <div :class="[baseClass, toggleClass]">
          ...
          <button
            class="my-5 text-red-400 lg:bg-red-400 lg:hover:bg-red-500 lg:text-white flex justify-between items-center "
            @click="saveDiagram">
            <span>Save</span>
    ...
    <FlowChartModal :visible="isModalVisible" title="Save Diagram" @confirm="handleSave" @cancel="handleCancel" />
    <div v-if="success" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
      <div class="bg-white p-6 rounded-lg">
        <h3 class="text-lg font-semibold p-5 text-green-600">Chart saved successfully</h3>
