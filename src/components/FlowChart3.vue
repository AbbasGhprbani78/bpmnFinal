...
<path fill-rule="evenodd" d="M10.5 3.75a6 6 0 0 0-5.98 6.496A5.25 5.25 0 0 0 6.75 20.25H18a4.5 4.5 0 0 0 2.206-8.423 3.75 3.75 0 0 0-4.133-4.303A6.001 6.001 0 0 0 10.5 3.75Zm2.03 5.47a.75.75 0 0 0-1.06 0l-3 3a.75.75 0 1 0 1.06 1.06l1.72-1.72v4.94a.75.75 0 0 0 1.5 0v-4.94l1.72 1.72a.75.75 0 1 0 1.06-1.06l-3-3Z" clip-rule="evenodd" />
    ...
    <div class="flex justify-between items-center lg:mt-8">
      <!-- <span class="hidden lg:ml-16 xl:ml-24 lg:block capitalize font-bold text-lg left-2/4 transform -translate-x-1/2 lg:translate-x-0 lg:right-8 lg:left-auto">flow chart</span> -->
...
let diagramName = '';
let storedDiagramXML = "";
const dataDiagram = ref([]);
const maindiagram = ref(null);
...
const handleSave = async (name) => {
  try {
    ...
    const id=localStorage.getItem("process_id")
    ...
    const response = await axios.put("https://operapi.ariisco.com/update-diagram/", formData, {
      headers: {
